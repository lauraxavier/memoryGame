...
export const $playerNameTitle = document.getElementById("player-name-title");
export const $easy = document.getElementById("easy");
export const $medium = document.getElementById("medium");
export const $difficult = document.getElementById("difficult");
export const $sendName = document.getElementById("send-name");
export const $playerName = document.getElementById("player-name");
